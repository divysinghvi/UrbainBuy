...
class CategoryItemsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var categoryItems = products.where((product) => product['category'].toLowerCase() == category.toLowerCase()).toList();

    return Scaffold(
      backgroundColor: Colors.white,
      appBar: AppBar(
        title: Text('$category Items',style: GoogleFonts.notoSansRejang(),),
        backgroundColor: Colors.white,
      ),
      body: Padding(
